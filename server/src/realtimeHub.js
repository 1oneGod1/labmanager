...
function normalizeDeepFreezeStatusPayload(payload = {}) {
  ...
  return {
    ...
    uwf_conflict: payload.uwf_conflict === true,
    uwf_conflict_detected: payload.uwf_conflict_detected === true,
    uwf_deactivation_scheduled: payload.uwf_deactivation_scheduled === true,
    uwf_current_enabled: payload.uwf_current_enabled === true,
    uwf_next_enabled: payload.uwf_next_enabled === true,
    uwf_current_protected: payload.uwf_current_protected === true,
    uwf_next_protected: payload.uwf_next_protected === true,
    faronics_state_known: payload.faronics_state_known === true,
